-- DevBase full schema (reference copy — mirrors the migration file)
-- Run this in a fresh Supabase project to get started.
-- For existing projects: see supabase/migrations/ for incremental changes.
